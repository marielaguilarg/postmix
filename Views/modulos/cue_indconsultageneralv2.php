...
<div class="box-header"><h3 class="box-title"><?php echo T_("DATOS DEL ESTABLECIMIENTO")?></h3></div>
	<div class="box-body">
 
      <div class="row">
        <div class="col-md-3"><?php echo T_("REPORTE DE VISITA")?>: <strong><?php echo $datosEstController->getInfoGeneral()["ReporteN"]?></strong></div>
   
        <div class="col-md-3"><?php echo T_("PUNTO DE VENTA")?> <strong><?php echo $datosEstController->getInfoGeneral()["PuntoVenta"]?></strong></div>
      </div>
    
  <div class="row">
    <div class="col-md-3"><?php echo T_("ID PEPSI")?>:<strong><?php echo $datosEstController->getInfoGeneral()["IDPepsi"]?></strong></div>
 
    <div class="col-md-3"><?php echo T_("ID CUENTA")?>:<strong><?php echo $datosEstController->getInfoGeneral()["IDCuenta"]?></strong></div>
  </div>
</div>
...
<div class="box" ><div class="box-header"><h3 class="box-title"><?php echo T_("DIRECCION")?></h3></div>
<div class="box-body">
  <div class="row">
   
        <div class="col-md-3"><?php echo T_("CALLE")?>:<strong><?php echo $datosEstController->getInfoGeneral()["Direccion1"]?></strong></div>
     
        <div class="col-md-3"><?php echo T_("NO. EXTERIOR") ?>:<strong><?php echo $datosEstController->getInfoGeneral()["Direccion2"]?></strong></div>
    </div>
    <div class="row">
      ...
      <div class="row">
        <div class="col-md-3"><?php echo T_("COLONIA")?>:<strong><?php echo $datosEstController->getInfoGeneral()["Direccion6"]?></strong></div>
       <div class="col-md-3"><?php echo T_("C.P.")?>:<strong><?php echo $datosEstController->getInfoGeneral()["Direccion8"]?></strong></div>
      </div>
      <div class="row">
         <div class="col-md-3"><?php echo T_("DELEGACION")?>:<strong><?php echo $datosEstController->getInfoGeneral()["Direccion5"]?></strong></div>
        <div class="col-md-3"><?php echo T_("CIUDAD")?>:<strong><?php echo $datosEstController->getInfoGeneral()["Direccion9"]?></strong></div>
       </div>
      <div class="row"> 
        <div class="col-md-3"><?php echo T_("ESTADO")?>:<strong><?php echo $datosEstController->getInfoGeneral()["Direccion7"]?></strong></div>
     
        <div class="col-md-3"><?php echo T_("TELEFONO")?>:<strong><?php echo $datosEstController->getInfoGeneral()["Direccion10"]?></strong></div>
      </div>
      <div class="row">
...
<div class="box" ><div class="box-header"><h3 class="box-title"><?php echo T_("DATOS DE LA VISITA")?></h3></div>
...
<div class="box">
<div class="box-header"><h3 class="box-title"><?php echo T_("CLASIFICACION")?></h3></div>
    <div class="box-body">
       <div class="row">
