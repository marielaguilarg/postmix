...
<a  class="btn btn-default pull-right" style="margin-right: 18px" href="index.php?action=snuevopermiso&id=<?php echo $permisoController->getIdGrup() ?>" > <i class="fa fa-plus-circle" aria-hidden="true"></i>  Nuevo  </a>
       </div>
...
<div class="description-block">
 ...
 <a class="btn btn-block btn-info" onclick="return confirmar();" href="index.php?action=slistapermisos&admin=borrar&id2=<?php echo $permiso["borraid"]."&id=".$permisoController->getIdGrup() ?>"><i class="fa fa-trash-o"></i></a>
 </div>
