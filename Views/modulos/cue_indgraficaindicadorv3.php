  ...
  function graficasEstandar(urlDatos,container1){
    anychart.onDocumentReady(function () {
           ...
           //  console.log(Object.values(dataagua));
            drawColumns(data,"nose",container1, anychart.palettes.defaultPalette);
...
echo ' graficasEstandar("' . $graficaIndicador->getUrlIndicadores() . 'DetN","contestandar1");';
echo ' graficasEstandar("' . $graficaIndicador->getUrlIndicadores() . 'DetM","contestandar2");';
