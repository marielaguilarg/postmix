...
une_fechaestatus= :fecest where une_id=:numunineg";
    ...
    function nombrePV($cuenta, $franquicia, $ptv) {
        ...
        $sql_titulo = "SELECT * 
    FROM ins_generales
    Inner Join ca_unegocios ON ins_generales.i_idcliente = ca_unegocios.cli_idcliente AND ins_generales.i_claveservicio = ca_unegocios.ser_claveservicio AND ins_generales.i_clavecuenta = ca_unegocios.cue_clavecuenta AND ca_unegocios.cli_idcliente = ins_generales.i_idcliente AND ca_unegocios.ser_claveservicio = ins_generales.i_claveservicio AND ins_generales.i_claveuninegocio = ca_unegocios.une_id
