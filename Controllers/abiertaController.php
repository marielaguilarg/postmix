...
class abiertaController{
	...
	echo '<div class="row">
    <div class="col-md-12" ><button  class="btn btn-default pull-right" style="margin-right: 18px; margin-top:15px; margin-bottom:15px;"><a href="index.php?action=nuevaabierta&id='.$seccion.'&ids='.$servicioController.'" > <i class="fa fa-plus-circle" aria-hidden="true"></i>  Nuevo  </a></button>
     </div>
     </div>';
		...
		default:
	      ...
	      $respuesta = DatosAbierta::actualizaAbiertaDetalleModel($datosController, "cue_reactivosabiertosdetalle");
			...
			echo "
				...
				window.location.href='index.php?action=sn&sec=".$secori."&ts=AD&sv=1';
				</script>
				";
		}
