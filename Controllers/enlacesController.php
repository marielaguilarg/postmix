...
class enlacesController{
  ...
  $filx=filter_input(INPUT_GET, "filx", FILTER_SANITIZE_STRING);
    ...
    //foreach($respuesta as $row => $item){
      echo '<li class="treeview">
        <a href="index.php?action=indgraficaindicadorgr&mes='.$mes."&sec=".$seccion."&filx=".$filx."&niv=2&filuni=".$respuesta["n2_id"].'"><em class="fa fa-circle-o"></em>'.$respuesta["n2_nombre"] .'<span class="pull-right-container">
                  <em class="fa fa-angle-left pull-right"></em></spam>  
                  </a>
        <ul class="treeview-menu">';
